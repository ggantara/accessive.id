	...
	<form method="POST">	
		<div class="box-body">
			...
			<div class="form-group">
				...
				style="height: 100px" name="facility_info"> </textarea>
			</div>
			<div class="form-group">
				<label for="facilityIcon">Lambang untuk Fasilitas yang Tersedia </label>
				<input type="file" id="facilityIcon" class="form-control"
				name="facility_icon">
			</div>
			<div class="form-group">
				<label for="facilityUnavailableIcon">Lambang untuk Fasilitas yang Tidak Tersedia</label>
				<input type="file" id="facilityUnavailableIcon" class="form-control"
				name="facility_unavailable_icon">
			</div>
			<div class="form-group">
		...
		<button class="btn-primary btn btn-sm" id="simpan"><i class="fa fa-save"></i><span>	Simpan</span></button>	
